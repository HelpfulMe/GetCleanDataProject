...
## Thank you for grading my Getting and Cleaning Data assignment!

# I've included notes throughout the run_analysis.R code as well as direct
# quotes from the Project Assignment to indicate what the code does and why.
# Together with my CodeBook and README I hope you will recognize the work done
# and that all the aspects of the Getting and Cleaning Data project are 
# accomplished.
...
## To read tidy data file generated by run_analysis.R and saved in working directory: 
## (taken from thethoughtfulbloke helpful posting on this assignment)
## https://thoughtfulbloke.wordpress.com/2015/09/09/getting-and-cleaning-the-assignment/
## use the statements below, replacing 'file_path' with the location of 'mytidydata.txt'
## on your computer

# mytidydata <- read.table(file_path, header = TRUE)
# View(mytidydata)

# ie: mytidydata <- read.table("C:/Users/Becca New/Dropbox/Personal/
# Data Science Specialization/Getting and Cleaning Data/GetCleanDataProject/
# UCI HAR Dataset/mytidydata.txt", header = TRUE)
...
## read data from the 'test' subject group
# X_test.txt
...
## read data from the 'train' subject group
# X_train.txt
